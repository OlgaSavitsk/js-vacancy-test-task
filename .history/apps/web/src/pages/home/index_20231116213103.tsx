import { ChangeEvent, ReactNode, useCallback, useLayoutEffect, useState } from 'react';
...
const Home: NextPage = () => {
  ...
  const methods: JSX.IntrinsicAttributes & { children: ReactNode | ReactNode[]; } & UseFormReturn<FieldValues, any>; const
    { getValues } = useForm<SalaryParams>({
