...
const paymentValue = z.intersection(
  z.object({ price: z.array(z.string().nullable()).optional() }),
  z.object({ searchValue: (z.string().optional()) }),
);
...
const Home: NextPage = () => {
  ...
  useLayoutEffect(() => {
    setParams((prev) => ({
      ...prev,
      page: 1,
      searchValue: filterDate?[1].searchValue || undefined,
      perPage: PER_PAGE,
    }));
    setFilterDate([
      {
