...
const Home: NextPage = () => {
  ...
  const filterData = useMemo(() => [params.price, params.searchValue], [params]);
  // eslint-disable-next-line max-len
  const handleRemove = useCallback((val: number) => return filterData.filter((_, index) => index !== val), [filterData]);
