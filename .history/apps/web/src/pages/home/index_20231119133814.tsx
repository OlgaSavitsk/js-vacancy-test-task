...
interface UsersListParams {
  ...
  price?: payment_from: string | null, payment_to: string | null,
  }
}
...
const Home: NextPage = () => {
  ...
  const onSubmit = ({ payment_from, payment_to }: SalaryParams) => {
    setParams((prev) => ({
      ...prev,
      price: [payment_from: payment_from ? payment_from.replace(/\$/g, '') : null, payment_to: payment_to ? payment_to.replace(/\$/g, '') : null]
    }));
  };
