...
const Home: NextPage = () => {
  ...
  const [filterDate, setFilterDate] = useState<PaymentRangeValue[]>([undefined]);
  ...
  useLayoutEffect(() => {
    ...
    setFilterDate([params.price ? [params.price.payment_from!, params.price?.payment_to!] : undefined, debouncedSearch!]);
