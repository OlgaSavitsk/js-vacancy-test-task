...
const Home: NextPage = () => {
  ...
  const handleRemove = useCallback((val: string | (string | null)[]) => setFilterDate(
    Object.values(filterDate!).forEach((value) => console.log(value, val);
      // if (index === val) {
              ...
              <Group position="apart">
                <Stack>
                  ...
                  >
                    ...
                    {Object.values(filterDate).map((item, index) => (
                      item && (
                        <Pill
                          value={item}
