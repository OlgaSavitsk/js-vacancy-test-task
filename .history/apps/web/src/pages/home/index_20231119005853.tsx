...
const paymentValue = z.array(z.array(z.string().nullable().optional()), z.string().optional());
...
const Home: NextPage = () => {
  ...
  useLayoutEffect(() => {
    ...
    setFilterDate([[params.price!.payment_from, params.price?.payment_to], search: debouncedSearch!]);
