...
const Home: NextPage = () => {
  ...
  const [debouncedFilter] = useDebouncedValue(params.price?.payment_to, 1000);
  ...
  useLayoutEffect(() => {
    setParams((prev) => ({
      ...
      price: {
        payment_from: params.price?.payment_from,
        payment_to: debouncedFilter!,
      },
      perPage: PER_PAGE,
    }));
    setFilterDate([params.price!, params.searchValue!]);
  }, [debouncedFilter, debouncedSearch, params.price, params.searchValue]);
